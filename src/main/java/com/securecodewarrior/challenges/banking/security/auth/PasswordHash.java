package com.securecodewarrior.challenges.banking.security.auth;
...
public class PasswordHash{
    ...
    public static String createHash(final char[] password) throws NoSuchAlgorithmException, InvalidKeySpecException{
        ...
        // Hash the password
        final byte[] hash = PasswordHash.pbkdf2(password, salt, PasswordHash.PBKDF2_ITERATIONS, PasswordHash.HASH_BYTE_SIZE);
